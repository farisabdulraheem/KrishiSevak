                        ...
                        <a class="active-menu-top" href="#"><i class="fa fa-desktop "></i>Requests <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="active-menu" href="pending.php"><i class="fa fa-circle-o "></i>Pending</a>
                            </li>
                             <li>
       ...
       <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pending</h1>
                    </div>
                  </div>  
          <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    ...
                                    {
                                        $usid=implode('',$uids);
                                        $sql = mysqli_query($db,"SELECT * FROM `notification request` WHERE User_id=$usid AND Status='Pending'");
