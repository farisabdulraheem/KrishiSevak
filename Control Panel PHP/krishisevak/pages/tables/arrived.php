...
if ($db->connect_error) {
  ...
  //$usid=implode('',$uids);
  //$sql = mysqli_query($db,"SELECT * FROM `notification request` WHERE User_id=$usid");
?>
<!DOCTYPE php>
<php>
<head>
                    ...
                    <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-desktop "></i>Requests <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="arrived.php"><i class="fa fa-bell "></i>Arrived</a>
                            </li>
                             <li>
       ...
       <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Arrived</h1>
                    </div>
                  </div> 
